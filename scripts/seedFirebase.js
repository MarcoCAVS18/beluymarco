...
async function seedConfig() {
  ...
  const config = {
    ...
    resumes: [
      ...
      { id: 3, type: 'Housekeeping', person: 'Belu', file: 'Resume HK - September 2026 - Maria Belen Corzo.pdf', path: '/resumes/Resume HK - September 2026 - Maria Belen Corzo.pdf' },
      { id: 4, type: 'Housekeeping', person: 'Marco', file: 'Resume HK - September 2026 - Marco Piermatei.pdf', path: '/resumes/Resume HK - September 2026 - Marco Piermatei.pdf' },
    ],
    otherDocuments: [
